...
(function (global, factory) {
    ...
    var linkDialog = function (opt) {
        var body = '<div class="note-form-group">' +
            ...
            (!opt.disableLinkTarget
                ? '<div class="checkbox">' +
                    '<input type="checkbox" name="targetBlank" id="targetBlank" checked>' + 
                    '<label for="targetBlank" data-off="" data-on="' + opt.lang.link.openInNewWindow + '"></label>' +
                    '</div>' : '');
        var footer = [
    ...
    var checkbox = renderer.create('<div class="checkbox"></div>', function ($node, options) {
        $node.html([
            ' <input role="checkbox" type="checkbox" id="targetBlank" name="targetBlank" class="btn-switch"' + (options.id ? ' id="' + options.id + '"' : ''),
            (options.checked ? ' checked' : ''),
            ' aria-checked="' + (options.checked ? 'true' : 'false') + '"/>',
            '<label for="targetBlank" data-on="Nuova scheda"></label>',
        ].join(''));
    });
    ...
    var LinkDialog = /** @class */ (function () {
        ...
        LinkDialog.prototype.initialize = function () {
            ...
            var body = [
                ...
                '</div>',
                '<div class="form-group note-form-group">',
                '<input class="note-link-url form-control note-form-control note-input" placeholder="' + this.lang.link.url + '"type="text" value="http://" />',
                '</div>',
            ...
            var buttonClass = 'btn btn-rounded text-center color-white box-shadow background-color-blue-light margin-top-small note-link-btn';
            var footer = "<input type='button' class='" + buttonClass + "' value='" + this.lang.link.insert + "' disabled>";
    ...
    var ImageDialog = /** @class */ (function () {
        ...
        ImageDialog.prototype.initialize = function () {
            ...
            var body = [
                ...
                '<input class="note-image-input form-control-file note-form-control note-input" type="file" name="files" id="files" accept="image/*" multiple="multiple" />',
                '<label class="btn upload text-center box-shadow border-radius-small background-color-pink-light color-white" for="files">' + this.lang.image.selectFromFiles + '</label>',
                imageLimitation,
                '</div>',
